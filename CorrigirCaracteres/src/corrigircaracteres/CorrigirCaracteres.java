...
public class CorrigirCaracteres {
	...
	public static void main (String [] args) {
		try {
			...
			char[] a = {'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î', 'Ï', 'Ð', 'Ñ', 'Ò', 'Ó', 'Ô',
					...
					'Ί', 'ί', 'ϊ', 'ΐ', 'Ύ', 'ύ', 'ϋ', 'ΰ', 'Ή', 'ή', '$', '²', 'ß', 'Ø', 'º', '«', '@', '', '”', 'ˆ', '‡', '±',
					'—', 'Þ', '©', '{', '¥', '¬', '¹', '?', '›', '', ''}; /** Os dois ultimos estao com caracteres que nao conseguimos ver*/
			
			String[] b = {"A", "A", "A", "A", "O", "A", "AE", "C", "O", "E", "E", "E", "I", "O", "I", "", "D", "O", "O", "O", "O",
					"O", "O", "U", "U", "U", "U", "Y", "a", "a", "a", "a", "O", "a", "ae", "c", "O", "e", "e", "e", "i",
					"O", "i", "", "O", "o", "o", "o", "o", "o", "o", "u", "u", "u", "u", "y", "y", "A", "a", "A", "a", "A", "a",
					...
					"n", "O", "o", "O", "o", "O", "o", "OE", "oe", "R", "r", "R", "r", "R", "r", "S", "s", "S", "s", "S", "s", "A",
					"A", "T", "t", "T", "t", "T", "t", "U", "u", "U", "u", "U", "u", "U", "u", "U", "u", "U", "u", "W", "w", "Y",
					"y", "Y", "Z", "z", "Z", "z", "Z", "z", "s", "f", "O", "o", "U", "u", "A", "a", "I", "i", "O", "o", "U", "u",
					"U", "u", "U", "u", "U", "u", "U", "u", "A", "a", "AE", "ae", "O", "o", "Α", "α", "Ε", "ε", "Ο", "ο", "Ω", "ω",
					"Ι", "ι", "ι", "ι", "Υ", "υ", "υ", "υ", "Η", "η", "C", "I", "A", "", "C", "C", "A", "", "E", "E", "", "E",
					"", "A", "E", "O", "I", "N", "", "/", "E", "A", "C"};
