...
public class FiltrarCaracter {
	...
	public static void main (String [] args) {
		try {
			 ...
			 * Leitura do arquivo;
			 */
			FileInputStream arquivo1 = new FileInputStream ("nomeematricula.txt");
						...
						if (i == 0) {
							...
							for (int j = 0; j < n.length; j++) {
								if (n[j] != 'A' && n[j] != 'B' && n[j] != 'C' && n[j] != 'D' && n[j] != 'E' && n[j] != 'F' && n[j] != 'G' && n[j] != 'H' && 
										...
										n[j] != 'Y' && n[j] != 'Z' && n[j] != ' ' && n[j] != '.' && n[j] != '&' && n[j] != '/' && n[j] != '0' && n[j] != '1' && 
										n[j] != '2' && n[j] != '3' && n[j] != '4' && n[j] != '5' && n[j] != '6' && n[j] != '7' && n[j] != '8' && n[j] != '9' && 
										n[j] != '(' && n[j] != ')' && n[j] != '_' && n[j] != ',' && n[j] != '"' && n[j] != '+' && n[j] != '[' && n[j] != ']' && 
